      ...
      <nav className="fixed top-0 w-full z-50 bg-white/90 backdrop-blur-md border-b border-stone-100 h-20">
        <div className="max-w-[1600px] mx-auto px-6 md:px-12 h-full flex justify-between items-center relative">
          ...
          <div className="flex-1 flex items-center gap-8">
            {backButton ? (
              <Link to="/" className="text-stone-400 hover:text-stone-900 transition-colors flex items-center gap-2 text-[11px] font-bold uppercase tracking-widest">
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><line x1="19" y1="12" x2="5" y2="12"></line><polyline points="12 19 5 12 12 5"></polyline></svg>
                Volver
              </Link>
            ) : (
              <div className="hidden md:flex gap-8 items-center">
                <Link to="/" className="text-stone-500 hover:text-stone-900 transition-colors uppercase tracking-wider text-[11px]">Inicio</Link>
                ...
                <Link to="/shop/nuevos" className="text-stone-500 hover:text-stone-900 transition-colors uppercase tracking-wider text-[11px]">Nuevos</Link>
              </div>
            )}
          </div>
          ...
          <div className="flex gap-6 text-stone-600 flex-1 justify-end">
            ...
            <Link to="/profile" className="hover:text-stone-900 transition-transform hover:scale-110"><UserIcon /></Link>
            <button onClick={() => setCartOpen(true)} className="hover:text-stone-900 transition-transform hover:scale-110 relative">
              <CartIcon />
              <span className="absolute -top-2 -right-2 bg-stone-900 text-white text-[9px] font-bold w-4 h-4 rounded-full flex items-center justify-center">
                {totalItems}
              </span>
            </button>
          </div>
