...
const Home = () => {
  ...
  return (
    <div className="bg-[#FCFCFC] min-h-screen text-stone-900 font-sans selection:bg-stone-200">
      ...
      {/* --- CATEGORÍAS (Modificado a 3 columnas perfectas) --- */}
      <section className="py-20 px-6 md:px-12 max-w-[1600px] mx-auto">
        ...
        {/* Cambiado de grid-cols-4 a grid-cols-3 */}
      ...
      <footer className="bg-white pt-20 pb-10 px-6 md:px-12 border-t border-stone-200">
        <div className="max-w-[1600px] mx-auto grid grid-cols-1 md:grid-cols-4 gap-12 mb-16">
          ...
          <div>
            ...
            <ul className="space-y-4 text-sm text-stone-500">
              ...
              <li><Link to="/shop" className="hover:text-stone-900 transition-colors">Catálogo completo</Link></li>
              <li><Link to="/faq" className="hover:text-stone-900 transition-colors">Preguntas Frecuentes</Link></li>
              <li><Link to="/contact" className="hover:text-stone-900 transition-colors">Contacto</Link></li>
            </ul>
          </div>
        ...
        <div className="max-w-[1600px] mx-auto border-t border-stone-100 pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
          ...
          <div className="flex gap-6">
            <a href="#" className="text-stone-400 hover:text-stone-900 transition-colors text-xs font-bold uppercase tracking-wider">Instagram</a>
            <a href="#" className="text-stone-400 hover:text-stone-900 transition-colors text-xs font-bold uppercase tracking-wider">Tiktok</a>
          </div>
        </div>
      </footer>
