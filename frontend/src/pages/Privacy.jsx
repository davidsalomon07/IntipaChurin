  ...
  return (
    <div className="bg-[#FCFCFC] min-h-screen text-stone-900 font-sans selection:bg-stone-200 pb-24">
      ...
      <main className="max-w-3xl mx-auto px-6 pt-36">
        <h1 className="text-4xl font-bold tracking-tight mb-12">Aviso de Privacidad</h1>
        
        <div className="space-y-8 text-stone-600 leading-relaxed text-sm md:text-base">
          <section>
            <h2 className="text-xl font-bold text-stone-900 mb-4">1. Recopilación de Información</h2>
          ...
          <section>
            <h2 className="text-xl font-bold text-stone-900 mb-4">2. Uso de tu Información</h2>
          ...
          <section>
            <h2 className="text-xl font-bold text-stone-900 mb-4">3. Protección y Consentimiento</h2>
